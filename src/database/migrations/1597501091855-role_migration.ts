...
export class roleMigration1597501091855 implements MigrationInterface {
    name = 'roleMigration1597501091855'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user-details" ("id" SERIAL NOT NULL, "name" character varying(50) NOT NULL, "lastName" character varying, "email" character varying NOT NULL, "status" character varying(8) NOT NULL DEFAULT 'ACTIVE', "created_at" TIMESTAMP NOT NULL, "updated_at" TIMESTAMP NOT NULL, CONSTRAINT "PK_19b6a3811b0ff3b46253d9ae2e6" PRIMARY KEY ("id"))`);
